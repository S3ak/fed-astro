...
<iframe
  src="https://codesandbox.io/embed/htmlcss-animations-and-transitions-rg01x9?fontsize=14&hidenavigation=1&theme=dark"
  style="border:0; border-radius: 4px; overflow:hidden;"
  title="htmlcss Animations and Transitions"
...
<iframe
  src="https://codesandbox.io/embed/htmlcss-animations-and-transitions-rg01x9?fontsize=14&hidenavigation=1&initialpath=%2Fexercise-1.html&module=%2Fexercise-1.html&theme=dark"
  style="border:0; border-radius: 4px; overflow:hidden;"
  title="htmlcss Animations and Transitions"
  allow="accelerometer; ambient-light-sensor; camera; encrypted-media; geolocation; gyroscope; hid; microphone; midi; payment; usb; vr; xr-spatial-tracking"
  sandbox="allow-forms allow-modals allow-popups allow-presentation allow-same-origin allow-scripts"
...
<iframe
  src="https://codesandbox.io/embed/htmlcss-animations-and-transitions-rg01x9?fontsize=14&hidenavigation=1&theme=dark&initialpath=%2Fexample-1.html&module=%2Fexample-1.html"
  style="border:0; border-radius: 4px; overflow:hidden;"
  title="htmlcss Animations and Transitions"
  allow="accelerometer; ambient-light-sensor; camera; encrypted-media; geolocation; gyroscope; hid; microphone; midi; payment; usb; vr; xr-spatial-tracking"
  sandbox="allow-forms allow-modals allow-popups allow-presentation allow-same-origin allow-scripts"
