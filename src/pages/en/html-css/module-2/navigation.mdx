...
- By default, the browser indents the `<ul>` so we remove that by setting the margin & padding to 0px.
...
Create a navigation list that consists of home, about, and contact. The home page should be the current page.

<iframe
  src="https://codesandbox.io/embed/fed-htmlcss-navigation-yfp6qn?fontsize=14&hidenavigation=1&theme=dark&view=preview"
  style="width:100%; height:500px; border:0; border-radius: 4px; overflow:hidden;"
  title="fed-htmlcss-navigation"
