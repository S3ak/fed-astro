...
<div style="display: flex; background: black">
  <div class="item">
    <p>| Row 1: This is a flex item </p>
  </div>
  <div class="item">
    <p>| Row 2: This is a flex item </p>
  </div>
  <div class="item">
    <p>| Row 3: This is a flex item</p>
  </div>
</div>
...
<iframe
  src="https://codesandbox.io/embed/htmlcss-m3-flexbox-2j4pi5?fontsize=14&hidenavigation=1&theme=dark"
  style="width:100%; height:500px; border:0; border-radius: 4px; overflow:hidden;"
  title="htmlcss-m3-flexbox"
...
<main
  style="display: flex; background: brown;
  justify-content: space-around;"
>
  <section>One</section>
  <section>Two</section>
