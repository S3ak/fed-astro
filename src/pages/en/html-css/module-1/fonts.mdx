...
- Apply the font to all the text on the page

<iframe
  src="https://codesandbox.io/embed/fed-html-css-fonts-hnlvs1?fontsize=14&hidenavigation=1&theme=dark"
  style="width:100%; height:500px; border:0; border-radius: 4px; overflow:hidden;"
  title="fed-html-css-fonts"
