...
<iframe
  src="https://codesandbox.io/embed/loops-tvtmld?expanddevtools=1&fontsize=14&hidenavigation=1&moduleview=1&theme=dark"
  style="border:0; border-radius: 4px; overflow:hidden;"
  title="fed-voc-foundational-programming-Loops"
...
<iframe
  src="https://player.vimeo.com/video/490475154"
  frameborder="0"
  allow="autoplay; fullscreen"
  allowfullscreen
></iframe>

<a href="https://vimeo.com/490475154/23fd9e35a7" target="_blank">
  Watch on Vimeo
</a>

<a
  href="https://github.com/NoroffFEU/for-loop/blob/master/script.js"
  target="_blank"
>
  Code from the video
</a>
