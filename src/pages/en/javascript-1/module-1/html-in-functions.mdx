...
description: In this lesson we will look at Function arguments. Returning values from functions, together with a practical example. Creating HTML inside a function from the values inside an array.
tags: JavaScript 1
...
<iframe
  src="https://player.vimeo.com/video/698117262?h=a442c4c07f&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479"
  width="1920"
  height="1080"
  frameborder="0"
